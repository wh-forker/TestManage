...
<html lang="zh-CN">
  ...
  <div class="container-fluid">
    <div class="navbar-header">
      <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
        ...
        <span class="icon-bar"></span>
            ...
            <a class="navbar-brand" class="active" href="jspPage/admin.jsp">管理员登录</a>
    </div>
	...
	<br> 
<center><h2><strong>学生信息详情</strong></h2> 
（注：无专业副项2的同学，那一栏显示空白或0.0属于正常现象。）<br><br>
 <input type="button" class="btn btn-primary" onclick="javascript:location.href='AdminInfoServlet'" value="返回">
	...
	<center>
	   ...
	   <hr>
	    ...
	    <center>	     
		<h3> 第 1 学期</h3>   
   <a href="ModifyStuScoreServlet?account=${stuInfo.account}&term=1">修改</a><br><br>
	<table border="1" align="center" width="70%" class="table-hover">
		<tr>
			<th>专业主项&nbsp;&nbsp;</th>
			<th>课堂类别</th>
	...
	<table border="1" align="center" width="70%" class="table-hover">
	   ...
	   <center>	     
		<h3> 第 2 学期</h3>   
   <a href="ModifyStuScoreServlet?account=${term2.account}&term=${term2.term}">修改</a><br><br>
	<table border="1" align="center" width="70%" class="table-hover">
		<tr>
			<th>专业主项&nbsp;&nbsp;</th>
			<th>课堂类别</th>
	...
	<table border="1" align="center" width="70%" class="table-hover">
		<tr>
		    ...
		    <center>	     
		<h3> 第 3 学期</h3>   
   <a href="ModifyStuScoreServlet?account=${term3.account}&term=${term3.term}">修改</a><br><br>
	<table border="1" align="center" width="70%" class="table-hover">
		<tr>
			<th>专业主项&nbsp;&nbsp;</th>
			<th>课堂类别</th>
	...
	<table border="1" align="center" width="70%" class="table-hover">
		<tr>
		    ...
		    <center>	     
		<h3> 第 4 学期</h3>   
   <a href="ModifyStuScoreServlet?account=${term4.account}&term=${term4.term}">修改</a><br><br>
	<table border="1" align="center" width="70%" class="table-hover">
		<tr>
			<th>专业主项</th>
			<th>课堂类别</th>
	...
	<table border="1" align="center" width="70%" class="table-hover">
		...
		<tr>
		    ...
		    <center>	     
		<h3> 第 5 学期</h3>   
   <a href="ModifyStuScoreServlet?account=${term5.account}&term=${term5.term}">修改</a><br><br>
	<table border="1" align="center" width="70%" class="table-hover">
		<tr>
			<th>专业主项&nbsp;&nbsp;</th>
			<th>课堂类别</th>
	...
	<table border="1" align="center" width="70%" class="table-hover">
		<tr>
		    ...
		    <center>	     
		<h3> 第 6 学期</h3>   
      <a href="ModifyStuScoreServlet?account=${term6.account}&term=${term6.term}">修改</a><br><br>
	<table border="1" align="center" width="70%" class="table-hover">
		<tr>
			<th>专业主项&nbsp;&nbsp;</th>
			<th>课堂类别</th>
	...
	<table border="1" align="center" width="70%" class="table-hover">
		<tr>
		    ...
		    <center>	     
		<h3> 第 7 学期</h3>   
   <a href="ModifyStuScoreServlet?account=${term7.account}&term=${term7.term}">修改</a><br><br>
	<table border="1" align="center" width="70%" class="table-hover">
		<tr>
			<th>专业主项&nbsp;&nbsp;</th>
			<th>课堂类别</th>
 ...
 <center>	     
		<h3> 第 8 学期</h3>   
   <a href="ModifyStuScoreServlet?account=${term8.account}&term=${term8.term}">修改</a><br><br>
	<table border="1" align="center" width="70%" class="table-hover">
		<tr>
			<th>专业主项&nbsp;&nbsp;</th>
			<th>课堂类别</th>
