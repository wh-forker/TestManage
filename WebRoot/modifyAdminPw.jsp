...
with (thisform)
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
            ...
            <li class="active" ><a href="modifyAdminPw.jsp">重置密码</a></li>
  ...
  <form name="myform"  method="post" id="mytable" onsubmit="return validate_form(this)" action="UpdateAdmPwdServlet">
