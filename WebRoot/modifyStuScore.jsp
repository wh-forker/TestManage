...
<html lang="zh-CN">
  ...
  <div class="container-fluid">
	...
	<br> 
<center><h2><strong>修改学生成绩</strong></h2>
 <input type="button" class="btn btn-primary" onclick="javascript:location.href='ViewStuInfoServlet?account=${stuInfo.account}'" value="返回">
	<br>	<hr>       
	<center>
