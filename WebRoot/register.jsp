...
<center><h2><strong>录入学生信息</strong></h2><br>
<input type="button" class="btn btn-primary" onclick="javascript:location.href='AdminInfoServlet'" value="返回">
	<br>	<hr>       
	<center>
	 	
	<form method="post" action="AddStuInfoServlet"  role="form" class="table-hover">
			<table width="30%" height="40%" border="1">
				...
				<tr>
					<td>专业主项</td>
					<td><input type="text" name="maincourse"  />*</td>
				</tr>
				<tr>
					<td>主项导师</td>
					<td><input type="text" name="mainteacher"  />*</td>
				</tr>
			 
				<td>专业副项1</td>
				<td><input type="text" name="secondcourse" />*</td>
				</tr>
				<tr>
					<td>副项1导师</td>
					<td><input type="text" name="secondteacher" />*</td>
				</tr>
	
				<td>专业副项2</td>
				<td><input type="text" name="secondcourse2" />(选填)</td>
				</tr>
				<tr>
					<td>副项2导师</td>
					<td><input type="text" name="secondteacher2" />(选填)</td>
				</tr>
				<tr>
