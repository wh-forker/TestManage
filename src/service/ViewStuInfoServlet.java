...
public class ViewStuInfoServlet extends HttpServlet {
	@Override
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		request.getSession().setAttribute("stuInfo",si);
		...
		request.getRequestDispatcher("viewStuInfo.jsp").forward(request, response);
	}
